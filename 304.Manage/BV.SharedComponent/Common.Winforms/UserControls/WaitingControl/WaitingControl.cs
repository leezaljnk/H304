...
{
    public static class WaitingControl
    {
        private static Form m_SplashForm = null;
        private static ISplashProcess m_SplashInterface = null;
        ...
        public static void Show(Type splashFormType, string thongbao)
        {
            if (m_SplashThread != null)
                return;
            if (splashFormType == null)
        ...
        private static void CreateInstance(Type FormType)
        {
            ...
            m_SplashInterface = obj as ISplashProcess;
